...
PKG_NAME="retroarch"
PKG_VERSION="1df0285091dd913c96b52a1d39eef535a36d67b3"
...
if [[ "$ARCH" == "arm" ]] && [[ "$EMUELEC_ADDON" != "Yes" ]]; then
  ...
  sed -i -e "s/# cheat_database_path =/cheat_database_path =\/usr\/config\/retroarch\/cheats/" $INSTALL/etc/retroarch.cfg
